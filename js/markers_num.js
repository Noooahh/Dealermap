...
L.marker([-5579.25, 2807], {icon: cardIcon3}).addTo(map)
  .bindPopup("<h2>Moringwood 1</h3><p><a href='https://i.imgur.com/AEjqlHg.jpg' data-lightbox='image-1' data-title='Morningwood 1'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
...
L.marker([-4750, 3900], {icon: cardIcon3}).addTo(map)
  .bindPopup("<h2>das test</h3><p><a href='https://i.imgur.com/p0ZZebp.png' data-lightbox='image-1' data-title='testo'>Open In-Game Screenshot</a><div class='input-group input-group-sm mb-3'></div></div></p>");
